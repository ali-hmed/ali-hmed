<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Ali%20Ahmed&fontSize=70&fontColor=fff&animation=twinkling&fontAlignY=38&desc=Full-Stack%20Developer%20%7C%20Otaku%20%7C%20Gamer%20%7C%20Mobile%20Craftsman&descAlignY=60&descSize=18" />

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Full-Stack+Developer+%F0%9F%9A%80;React+Native+%26+Expo+Explorer+%F0%9F%93%B1;Next.js+%7C+Node.js+%7C+TypeScript+%E2%9A%A1;Anime+Otaku+%F0%9F%8E%8C+%7C+Gamer+%F0%9F%8E%AE;Building+the+future%2C+one+commit+at+a+time+%F0%9F%94%A5)](https://git.io/typing-svg)

![Profile Views](https://komarev.com/ghpvc/?username=ali-hmed&style=for-the-badge&color=58A6FF&label=PROFILE+VIEWS)
[![committers.top badge](https://user-badge.committers.top/somalia_private/ali-hmed.svg)](https://user-badge.committers.top/somalia_private/ali-hmed)
...
const ali = {
  ...
  learning:   ["React Native", "Expo", "Mobile Development"],
  stack:      ["Next.js", "Node.js", "TypeScript", "React"],
  passions:   ["Clean UI", "Scalable Systems", "Anime 🎌", "Gaming 🎮"],
  funFact:    "I debug code the same way I watch anime — with full focus 👁️‍🗨️",
};
```

I'm a **Full-Stack Developer** focused on building modern, scalable, and high-performance web applications with clean UI and smooth user experiences. I primarily work with **Next.js**, **Node.js**, **React**, and modern backend technologies to develop fast, reliable systems across both frontend and backend.

Currently expanding into **React Native & Expo** to craft beautiful cross-platform mobile experiences 📱

Outside of dev, I stay engaged in tech discussions, UI inspiration, and **anime recommendations** — hit me up if you want series recs! 🎌
...
- 📱 **Learning** React Native & Expo for mobile development
- 🌱 Exploring **cross-platform** mobile architecture
- 🎮 Gaming in my free time (yes, both games and code are art)
- 🎌 Watching anime and getting inspired by the storytelling craft
